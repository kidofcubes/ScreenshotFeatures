...
public class Configs implements IConfigHandler {
    ...
    public static class CameraMatrix {
        ...
        public static final ConfigDoubleHotkeyed ORTHOGONAL_OFFSET = setupConfig(new ConfigDoubleHotkeyed("orthogonalOffset", 0.0, "", -Double.MAX_VALUE, Double.MAX_VALUE, 1.0));
